...
# 读入两幅图片 图片中有相同部分
img1 = cv2.imread("/Users/liuxiaoxu/Downloads/puzzles/cattmp1.png", cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread("/Users/liuxiaoxu/Downloads/puzzles/cat.png", cv2.IMREAD_GRAYSCALE)
